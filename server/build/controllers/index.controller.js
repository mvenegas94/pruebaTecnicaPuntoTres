...
exports.obtenerUbicaciones = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const response = yield conexion_1.pool.query('SELECT * FROM location');
...
exports.obtenerUbicacionPorId = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const response = yield conexion_1.pool.query('SELECT * FROM location WHERE ID = $1', [id]);
        return res.status(200).json(response.rows);
    }
    catch (e) {
        console.log(e);
...
exports.crearUbicacion = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const response = yield conexion_1.pool.query('INSERT INTO LOCATION (id, name, area_ms, id_recursive) VALUES (DEFAULT, $1, $2, $3)', [name, area_ms, id_recursive]);
...
exports.actualizarUbicacion = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const id = parseInt(req.params.id);
        const { name, area_ms, id_recursive } = req.body;
        const response = yield conexion_1.pool.query('UPDATE location SET NAME = $2, AREA_MS= $3, ID_RECURSIVE = $4 WHERE ID = $1', [id, name, area_ms, id_recursive]);
        return res.status(200).json({
...
exports.eliminarUbicacion = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const id = parseInt(req.params.id);
        const response = yield conexion_1.pool.query('DELETE FROM location WHERE ID = $1', [id]);
        return res.status(200).json({
